  ...
  <transition name="slide">
    <div class="add-song" v-show="showFlag" @click.stop>
      ...
      <div class="shortcut" v-show="!query">
        <switches :currentIndex="currentIndex" @switch="switchItem"></switches>
          ...
          <scroll ref="searchList"  class="list-scroll" v-if="currentIndex === 1" :data="searchHistory"
            ...
            <div class="list-inner">
              <search-list @select="addQuery"
                           :searches="searchHistory" @delete="deleteOne"></search-list>
            </div>
          </scroll>
        </div>
      </div>
      <div class="search-result" v-show="query">
        <suggest :query="query" :zhida="0" @select="selectSuggest" @listScroll="blurInput"></suggest>
      </div>
      <top-tip ref="topTip">
        <div class="tip-title">
          <i class="icon-ok"></i>
